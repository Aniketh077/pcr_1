      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <div className="text-4xl font-bold">{metrics.totalRequests}</div>
            <div className="text-sm opacity-75 mt-2">All time</div>
          </div>

          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg shadow-lg p-6 text-white">
            <div className="text-sm opacity-90 mb-1">Pending</div>
            <div className="text-4xl font-bold">{metrics.pendingRequests}</div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            ...
            <div className="text-4xl font-bold">{metrics.confirmedRequests + metrics.dispatchedRequests}</div>
          ...
          <div className="bg-gradient-to-br from-gray-600 to-gray-700 rounded-lg shadow-lg p-6 text-white">
            ...
            <div className="text-4xl font-bold">{metrics.completedRequests}</div>
            <div className="text-sm opacity-75 mt-2">{metrics.fulfillmentRate}% fulfillment</div>
          </div>
        </div>
      )}
